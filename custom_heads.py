from transformers import PreTrainedModel,DistilBertPreTrainedModel,DistilBertModel,BertPreTrainedModel,BertModel
import torch
...
class BertForMultiLabelClassification(BertPreTrainedModel):
    ...
    def forward(
        ...
        r"""
        labels (:obj:`torch.LongTensor` of shape :obj:`(batch_size,num_labels,)`, `optional`, defaults to :obj:`None`):
            Labels for computing the sequence classification/regression loss.
            Indices should be in :obj:`[0, ..., config.num_labels - 1]`.
            If :obj:`config.num_labels == 1` a regression loss is computed (Mean-Square loss),
            If :obj:`config.num_labels > 1` a multilabel classification loss is computed (Binary Cross-Entropy).
    Returns:
